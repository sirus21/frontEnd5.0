...
<head>
	...
	<script type="text/javascript" src="js/Adobe_Caslon_Pro.font.js"></script>
	<script type="text/javascript" src="js/Minion_Pro.font.js"></script>
	<script type="text/javascript">
		Cufon.replace('.cufon-caslon', { fontFamily: 'Adobe Caslon Pro' });
		Cufon.replace('.cufon-minion, .ylButton span', { fontFamily: 'Minion Pro' });
	</script>
</head>
...
<div id="wrap">	
	   ...
	   <?php echo $this->element('partnerheader'); ?> 
	<div id="content">
